/////////////////////////////////////////////////////////////////////////////
// <copyright file="ShouldRemoveFileTests.cs" company="James John McGuire">
...
/// <summary>
/// Provides unit tests for the ShouldRemoveFile method under various
/// scenarios.
/// </summary>
[TestFixture]
internal class ShouldRemoveFileTests
{
	...
	public void FullyQualifiedExcludeCaseInsensitiveMatchReturnsFalse()
	{
		...
		Exclude exclude = new(path, ExcludeType.FileIgnore);
		excludes.Add(exclude);
	...
	public void MultipleExcludesOneMatchesReturnsFalse()
	{
		...
		Exclude exclude1 = new(objPath, ExcludeType.FileIgnore);
		Exclude exclude2 = new(nodeModulesPath, ExcludeType.FileIgnore);

		string vsPath = Path.Combine(dataPath, ".vs");
		Exclude exclude3 = new(vsPath, ExcludeType.FileIgnore);
	...
	public void MultipleExcludesMixedTypesOnlyRelevantTypesMatch()
	{
		...
		Exclude exclude3 = new(objPath, ExcludeType.FileIgnore);
	...
	{
		// This test documents that ShouldRemoveFile evaluates each
